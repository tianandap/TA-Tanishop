...
<html lang="en">
	<head>
		...
		<title>TANI SHOP</title>

		<link rel="icon" type="image/x-icon" href="<?php echo base_url()?>assets/img/logo.jpg">
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="header-logo">
								<a href="<?php echo base_url()?>" class="logo">
									<img src="<?php echo base_url()?>/assets/img/logo.jpg" alt="" style="height: 64px; width: 64px;">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
						...
						<!-- <div class="col-md-4">	 -->
							...
							<?php } else {?>
								<button class="primary-btn" style="margin-top: 12px;" onclick="window.location.href='<?php echo base_url()?>Logged_in'">Login / Register</button>
							<?php } ?>
						</div>
