						...
						<div class="col-md-4 col-xs-6">
							<div class="product">
								<div class="product-img">
									<img src="<?php echo base_url()?>/assets/img/<?php echo $products['prod_img']?>" style="height: 300px;" alt="" >
								</div>
								<div class="product-body">
									...
									<h4 class="product-price">Rp <?php echo $this->cart->format_number($products['prod_price']) ?></h4>
								</div>
